...
class SettingsTableSeeder extends Seeder
{
    public function run(): void
    {
        $data = [
            ...
            ['group' => 'notifications', 'name' => 'emails', 'value' => json_decode('{"contact_form": "admin@company.com", "request_form": "admin@company.com"}', true)],
            ['group' => 'services', 'name' => 'api', 'value' => json_decode('{"google_map": {"api_key": "AIzaSyCQ5KODzqooIP496GPLRaMAsZ4eN8Vro_U"}}', true)],
        ];
